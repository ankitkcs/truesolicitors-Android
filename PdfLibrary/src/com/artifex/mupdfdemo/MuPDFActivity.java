...
//			alert.show();
	...
	private void makeButtonsView() {
		mButtonsView = getLayoutInflater().inflate(R.layout.mupdf_activity, null);
		...
		mInfoView.setVisibility(View.INVISIBLE);
		mPageSlider.setVisibility(View.INVISIBLE);
		imgInApp = (ImageView) mButtonsView.findViewById(R.id.pdf_imgInApp);
		imgInApp.setOnClickListener(this);
		btnBack = (Button) mButtonsView.findViewById(R.id.pdf_btnBack);
		btnBack.setOnClickListener(this);
		Intent intent = getIntent();
		btnText = intent.getStringExtra("backBtnText");
	...
	private void showInAppDialog() {
		// message in this dialog is temp...will have to change in future.
		final Dialog dialog = getDialogWithTwoButton(this,
				getString(R.string.pdf_inappMsg), "");
		final Button btnOk = (Button) dialog
				.findViewById(R.id.defaultpopup_btnOk);
		final Button btnCancel = (Button) dialog
				.findViewById(R.id.defaultpopup_btnCancel);
	...
	public static Dialog getDialogWithTwoButton(final Context activity,
			final String message, String title) {

		final Dialog mDialog = new Dialog(activity, R.style.myBackgroundStyle);
		mDialog.setContentView(R.layout.default_message_popup);
		mDialog.setCanceledOnTouchOutside(false);
		mDialog.setCancelable(false);
		TextView txtTitle = (TextView) mDialog
				.findViewById(R.id.defaultpopup_txtTitle);
		txtTitle.setText(title);
		TextView txtMessage = (TextView) mDialog
				.findViewById(R.id.defaultpopup_txtMessage);
