 ...
 * 
 */
public class ViewMoreDetailDesc extends BaseContainerFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.activity_moredetail_desc,
				container, false);
	...
	private void initFragment(View view) {
		...
		setMoreDescScreenwise(intBundleMoreHeader);
